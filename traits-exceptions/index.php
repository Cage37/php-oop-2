...
require __DIR__ . '/classes/php/trait.php';
...
require __DIR__ . '/classes/php/error.php';
    ...
    <main>
        <div class="maincontainer">
            ...
            <?php foreach ($users as $user) : ?>
                <div class="usercard">
                    <p><span>Username: </span> <?= $user -> getName(); ?></p>
                    <p><span>Mail: </span><?php
                    try{
                        echo getError($user -> mail);
                    } catch (Exception $e) {
                        echo '<span style="color: red;">';
                        echo "Exception Error! " . $e->getMessage(); //. ' [File:Line] ' . $e->getFile() . ":" . $e->getLine();
                        echo '</span>';
                    }
                    ?></p>
                   <span>Ordered: </span> <p>
